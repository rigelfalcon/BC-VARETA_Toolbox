        ...
        function AgreeButtonPushed(app, event)
            ...
            if(app.CheckBox_Delta.Value)
                if(app.Spinner_delta_start.Value <= app.Spinner_delta_end.Value)
                    app.frequencies = [ app.frequencies ;app.Spinner_delta_start.Value,app.Spinner_delta_end.Value ];
                    row = row +1;
                else
            ...
            if(app.CheckBox_theta.Value)
                if(app.Spinner_theta_start.Value <= app.Spinner_theta_end.Value)
                    app.frequencies = [ app.frequencies ;app.Spinner_theta_start.Value, app.Spinner_theta_end.Value];
                    row = row +1;
                else
            ...
            if(app.CheckBox_alpha.Value)
                if(app.Spinner_alpha_start.Value <= app.Spinner_alpha_end.Value)
                    app.frequencies = [ app.frequencies ;app.Spinner_alpha_start.Value ,app.Spinner_alpha_end.Value ];
                    row = row +1;
                else
            ...
            if(app.CheckBox_beta.Value)
                if(app.Spinner_beta_start.Value <= app.Spinner_beta_end.Value)
                    app.frequencies = [ app.frequencies ;app.Spinner_beta_start.Value , app.Spinner_beta_end.Value];
                    row = row +1;
                else
